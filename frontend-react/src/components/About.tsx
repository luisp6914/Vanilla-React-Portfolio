...
const About = () => {
    return (
        <article className="flex flex-col mt-[15dvh] p-16 md:flex-row gap-8 justify-center w-full">
            <h2 className="self-start relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-1/2 after:h-0.5 after:bg-[#656565] text-[clamp(2rem,3dvw,3rem)] text-[#656565] font-bold">About</h2>
